...
<body>
	<div id="wrapper" class="wrapper">
		...
		<div class="cookie-policy" style="display: none;">
			<div class="grid-x grid-padding-x flex align-center paddingtopsml paddingbottomsml">
				<div class="small-2 cell marginbottomxsml cookie">
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/header/cookie.svg"
						alt="Cookie" />
				</div>
				...
				<div class="cell small-12">
					<p>
						...
						use of cookies as outlined in our <a
							href="<?php echo esc_url(home_url('/privacy-policy/')); ?>">Privacy Notice</a>.
					</p>
		...
		<div id="wrapper-inner" <?php if (!is_search()):
			body_class(); else:
			body_class('wrapper-inner'); endif; ?>>
						...
						<div class="grid-x grid-padding-x">
							...
							<div
								...
								<img class="search-open"
									src="<?php echo get_template_directory_uri(); ?>/assets/images/header/search.svg"
									alt="<?php bloginfo('name'); ?>" />
